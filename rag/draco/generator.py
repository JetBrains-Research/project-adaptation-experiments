...
class Generator(object):
    ...
    def set_pyfile(self, project, fpath):
        ...
        # remove current file
        # TODO we don't need to remove the current file in our dataset
    ...
    def retrieve_prompt(self, datapoint: dict, completion_prefix: str):
        ...
        '''
        project = f"{datapoint['repo']}/{datapoint['commit_hash']}/{datapoint['completion_file']['filename']}"
        ...
        self.parser.parse(completion_prefix)
