...
class ModelTokenizer:
    def __init__(self, model):
        self.model = model
        self.config = attridict(yaml.load(open('draco/config.yaml', 'r'), Loader=yaml.FullLoader))
    ...
    def _set_tokenizer(self):
        if self.model == 'codegen':
            ...
            # TODO review code for deepseek case
    ...
    def truncate_concat(self, program, prompt, suffix):
        ...
        elif self.model == 'santacoder' or self.model == 'starcoder' or self.model == 'deepseek':
